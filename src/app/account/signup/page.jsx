...
<div className="flex flex-row items-center max-w-md 3 mx-auto justify-around">
    {/* <button onClick={()=>resetPWD(supabase)} className="dark:bg-primary-900 bg-primary-800 hover:bg-primary-700 dark:hover:bg-primary-600 text-white font-bold py-2 px-4 rounded m-4
    ">ResetPWD</button> */}
  <a href="/account/login" className="dark:bg-primary-900 bg-primary-800 hover:bg-primary-700 dark:hover:bg-primary-600 text-white font-bold py-2 px-4 rounded m-4">Login HERE</a> 
